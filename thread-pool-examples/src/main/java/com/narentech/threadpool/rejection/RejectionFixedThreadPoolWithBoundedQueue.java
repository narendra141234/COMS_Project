package com.narentech.threadpool.rejection;
...
public class RejectionFixedThreadPoolWithBoundedQueue {
	...
	public static void main(String[] args) {
		...
		LinkedBlockingDeque<Runnable> unboundedQueue = new LinkedBlockingDeque<>(queueCapacity);
